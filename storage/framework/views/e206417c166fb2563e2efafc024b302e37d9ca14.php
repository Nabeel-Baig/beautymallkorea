                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                            <img src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : 'https://ui-avatars.com/api/?background=random&name='.ucfirst(Auth::user()->name)); ?>" alt="" class="img-thumbnail rounded-circle">
                        </div>
                    ...
                    <table class="table align-middle table-nowrap">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <div>
                                        <img src="<?php echo e(asset('assets/images/product/img-7.png')); ?>" alt="" class="avatar-sm">
                                    </div>
                                </th>
                                <td>
                                    <div>
                            ...
                            <tr>
                                <th scope="row">
                                    <div>
                                        <img src="<?php echo e(asset('assets/images/product/img-4.png')); ?>" alt="" class="avatar-sm">
                                    </div>
                                </th>
                                <td>
                                    <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/domainname/public/beauty/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>