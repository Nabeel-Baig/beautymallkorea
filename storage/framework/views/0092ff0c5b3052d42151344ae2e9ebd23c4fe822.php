        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset($setting->logo)); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset($setting->logo)); ?>" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="index" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset($setting->logo)); ?>" alt="" height="19">
                    </span>
                </a>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0" key="t-ui-components"><?php echo app('translator')->get('translation.User_Management'); ?></h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);" key="t-lightbox"><?php echo app('translator')->get('translation.Permissions'); ?></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" key="t-range-slider"><?php echo app('translator')->get('translation.Roles'); ?></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" key="t-sweet-alert"><?php echo app('translator')->get('translation.Users'); ?></a>
                                        </li>
                                    </ul>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0" key="t-applications"><?php echo app('translator')->get('translation.Products'); ?></h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);" key="t-ecommerce"><?php echo app('translator')->get('translation.Categories'); ?></a>
                                        </li>
                                    </ul>
                                </div>

                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0" key="t-extra-pages"><?php echo app('translator')->get('translation.Orders'); ?></h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);" key="t-light-sidebar"><?php echo app('translator')->get('translation.Orders'); ?></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : 'https://ui-avatars.com/api/?background=random&name='.ucfirst(Auth::user()->name)); ?>"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('admin.settings.edit',$setting->id)); ?>"><i
                    ...
                    data-bs-target=".change-password"><i
                            ...
                            key="t-lock-screen"><?php echo app('translator')->get('translation.Change_Password'); ?></span></a>
...
<?php /**PATH /var/www/html/domainname/public/beauty/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>