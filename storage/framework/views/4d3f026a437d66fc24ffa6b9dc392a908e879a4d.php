                ...
                <div class="card-body">
                    <div class="float-right">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user_create')): ?>
                            <a class="btn btn-info" href="<?php echo e(route('admin.users.create')); ?>">Add</a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                <th><?php echo e(ucwords(str_replace('_',' ','phone'))); ?></th>
                                <td id="phone" align="center"></td>
                            </tr>
                            <tr>
                                <th><?php echo e(ucwords(str_replace('_',' ','gender'))); ?></th>
...
<?php $__env->startSection('script-bottom'); ?>
    <script>
        $(function () {
            var source = `<?php echo e(route('admin.'.request()->segment(2).'.index')); ?>`;
            ...
            $(document, this).on('click', '.view', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        document.getElementById('avatar').innerHTML = `<img alt="<?php echo e(asset('')); ?>${data.avatar}" src="<?php echo e(asset('')); ?>${data.avatar}" />`;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\beauty\resources\views/admin/users/list.blade.php ENDPATH**/ ?>