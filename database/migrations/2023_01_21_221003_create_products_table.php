...
class CreateProductsTable extends Migration {
	final public function up(): void {
		Schema::create("products", static function (Blueprint $table) {
			...
			$table->unsignedDecimal("dimension_length")->default(0.00);
			$table->unsignedDecimal("dimension_width")->default(0.00);
			$table->unsignedDecimal("dimension_height")->default(0.00);
