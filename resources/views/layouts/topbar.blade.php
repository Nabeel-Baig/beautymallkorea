								...
								@can('user_management_access')
									<div class="col-md-4">
										<h5 class="font-size-14 mt-0"
											key="t-ui-components">@lang('translation.User_Management')</h5>
										<ul class="list-unstyled megamenu-list">
											@can('permission_access')
												<li>
													<a href="{{ route('admin.permissions.index') }}"
													   key="t-lightbox">@lang('translation.Permissions')</a>
												</li>
											@endcan
											@can('role_access')
												<li>
													<a href="{{ route('admin.roles.index') }}"
													   key="t-range-slider">@lang('translation.Roles')</a>
												</li>
											@endcan
											@can('user_access')
												<li>
													<a href="{{ route('admin.users.index') }}"
													   key="t-sweet-alert">@lang('translation.Users')</a>
												</li>
											@endcan
										</ul>
									</div>
									...
									<ul class="list-unstyled megamenu-list">
										<li>
											<a href="javascript:void(0);"
											   key="t-light-sidebar">@lang('translation.Orders')</a>
										</li>
									</ul>
								</div>
							</div>
