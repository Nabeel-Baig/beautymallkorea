                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : 'https://ui-avatars.com/api/?background=random&name='.ucfirst(Auth::user()->name) }}" alt="" class="img-thumbnail rounded-circle">
                            </div>
