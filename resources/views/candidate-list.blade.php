...
@section('page-specific-css')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/libs/select2/select2.min.css') }}" rel="stylesheet">
@endsection
		...
		<div class="col-xl-3">
			<div class="card">
				<div class="card-body">
					...
					<div class="text-center mb-3">
						<img src="{{asset('assets/images/users/avatar-2.jpg')}}" alt="" class="avatar-sm rounded-circle"/>
		...
		<div class="col-xl-3">
			<div class="card">
				<div class="card-body">
					...
					<div class="text-center mb-3">
						<img src="{{asset('assets/images/users/avatar-3.jpg')}}" alt="" class="avatar-sm rounded-circle"/>
