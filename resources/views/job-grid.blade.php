    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/adobe.svg')}}" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/adobe-photoshop.svg')}}" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/airbnb.svg')}}" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/amazon.svg')}}" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/flutter.svg')}}" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/mailchimp.svg')}}" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/line.svg')}}" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/spotify.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/wordpress.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/upwork.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/sass.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{asset('assets/images/companies/reddit.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
